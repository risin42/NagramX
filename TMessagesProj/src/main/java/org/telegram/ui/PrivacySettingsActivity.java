    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener((view, position) -> {
            ...
            if (position == autoDeleteMesages) {
                ...
                if (newSuggest) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setTitle(getString(R.string.SuggestContactsTitle));
                    builder.setMessage(getString(R.string.SuggestContactsAlert));
                    builder.setPositiveButton(getString(R.string.MuteDisable), (dialogInterface, i) -> {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setTitle(getString(R.string.PrivacyPaymentsClearAlertTitle));
                builder.setMessage(getString(R.string.PrivacyPaymentsClearAlertText));
                ...
                for (int a = 0; a < 2; a++) {
                    String name;
                    if (a == 0) {
                        name = getString(R.string.PrivacyClearShipping);
                    } else {
                        name = getString(R.string.PrivacyClearPayment);
                    }
                    clear[a] = true;
                ...
                builder.setPositiveButton(getString(R.string.ClearButton), (dialogInterface, i) -> {
                    try {
                    ...
                    builder1.setTitle(getString(R.string.PrivacyPaymentsClearAlertTitle));
                    builder1.setMessage(getString(R.string.PrivacyPaymentsClearAlert));
                    builder1.setPositiveButton(getString(R.string.ClearButton), (dialogInterface2, i2) -> {
                        TLRPC.TL_payments_clearSavedInfo req = new TLRPC.TL_payments_clearSavedInfo();
                        req.credentials = clear[1];
                        req.info = clear[0];
                        getUserConfig().tmpPassword = null;
                        ...
                        String text;
                        if (clear[0] && clear[1]) {
                            text = getString(R.string.PrivacyPaymentsPaymentShippingCleared);
                        } else if (clear[0]) {
                            text = getString(R.string.PrivacyPaymentsShippingInfoCleared);
                        } else if (clear[1]) {
                            text = getString(R.string.PrivacyPaymentsPaymentInfoCleared);
                        } else {
                            return;
                        }
    ...
    public static String formatRulesString(AccountInstance accountInstance, int rulesType) {
        ...
        if (type == 0 || type == -1 && minus > 0) {
            ...
            if (rulesType == PrivacyControlActivity.PRIVACY_RULES_TYPE_P2P) {
                if (plus == 0 && minus == 0) {
                    return getString(R.string.P2PContacts);
                } else {
                    if (plus != 0 && minus != 0) {
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (position == webSessionsRow) {
                        textCell.setText(getString(R.string.WebSessionsTitle), false);
                    } else if (position == phoneNumberRow) {
                        ...
                        textCell.setTextAndValue(getString(R.string.PrivacyPhone), value, true);
                    } else if (position == lastSeenRow) {
                        ...
                        textCell.setTextAndValue(getString(R.string.PrivacyLastSeen), value, true);
                    } else if (position == groupsRow) {
                        ...
                        textCell.setTextAndValue(getString(R.string.Calls), value, true);
                    } else if (position == profilePhotoRow) {
                        ...
                        textCell.setTextAndValue(getString(R.string.PrivacyProfilePhoto), value, true);
                    } else if (position == bioRow) {
                        ...
                        textCell.setTextAndValue(getString(R.string.PrivacyBio), value, true);
                    } else if (position == birthdayRow) {
                        ...
                        textCell.setTextAndValue(getString(R.string.PrivacyForwards), value, true);
                    } else if (position == voicesRow) {
                        ...
                        textCell.setText(getString(R.string.TelegramPassport), true);
                    } else if (position == deleteAccountRow) {
                        ...
                        textCell.setTextAndValue(getString(R.string.DeleteAccountIfAwayFor3), value, deleteAccountUpdate, false);
                        deleteAccountUpdate = false;
                    } else if (position == paymentsClearRow) {
                        textCell.setText(getString(R.string.PrivacyPaymentsClear), true);
                    } else if (position == botsBiometryRow) {
                        textCell.setText(getString(R.string.PrivacyBiometryBotsButton), true);
                    } else if (position == secretMapRow) {
                        switch (SharedConfig.mapPreviewType) {
                            case 0:
                                value = getString(R.string.MapPreviewProviderTelegram);
                                break;
                            case 1:
                                value = getString(R.string.MapPreviewProviderGoogle);
                                break;
                            case 2:
                                value = getString(R.string.MapPreviewProviderNobody);
                                break;
                            case 3:
                            default:
                                value = getString(R.string.MapPreviewProviderYandex);
                                break;
                        }
                        textCell.setTextAndValue(getString(R.string.MapPreviewProvider), value, secretMapUpdate, true);
                        secretMapUpdate = false;
                    } else if (position == contactsDeleteRow) {
                        textCell.setText(getString(R.string.SyncContactsDelete), true);
                    }
                ...
                case 1:
                    ...
                    if (position == deleteAccountDetailRow) {
                        privacyCell.setText(getString(R.string.DeleteAccountHelp));
                    } else if (position == groupsDetailRow) {
                        privacyCell.setText(getString(R.string.GroupsAndChannelsHelp));
                    } else if (position == sessionsDetailRow) {
                        privacyCell.setText(getString(R.string.SessionsSettingsInfo));
                    } else if (position == secretDetailRow) {
                        privacyCell.setText(getString(R.string.SecretWebPageInfo));
                    } else if (position == botsDetailRow) {
                        privacyCell.setText(getString(R.string.PrivacyBotsInfo));
                        ...
                        privacyCell.setText(getString(R.string.SuggestContactsInfo));
                    } else if (position == newChatsSectionRow) {
                        privacyCell.setText(getString(R.string.ArchiveAndMuteInfo));
                    }
                    break;
                case 2:
                    HeaderCell headerCell = (HeaderCell) holder.itemView;
                    if (position == privacySectionRow) {
                        headerCell.setText(getString(R.string.PrivacyTitle));
                    } else if (position == securitySectionRow) {
                        headerCell.setText(getString(R.string.SecurityTitle));
                    } else if (position == advancedSectionRow) {
                        headerCell.setText(getString(R.string.DeleteMyAccount));
                    } else if (position == secretSectionRow) {
                        headerCell.setText(getString(R.string.SecretChat));
                    } else if (position == botsSectionRow) {
                        headerCell.setText(getString(R.string.PrivacyBots));
                    } else if (position == contactsSectionRow) {
                        headerCell.setText(getString(R.string.Contacts));
                    } else if (position == newChatsHeaderRow) {
                        headerCell.setText(getString(R.string.NewChatsFromNonContacts));
                    }
                    break;
                case 3:
                    TextCheckCell textCheckCell = (TextCheckCell) holder.itemView;
                    if (position == secretWebpageRow) {
                        textCheckCell.setTextAndCheck(getString(R.string.SecretWebPage), getMessagesController().secretWebpagePreview == 1, false);
                    } else if (position == contactsSyncRow) {
                        textCheckCell.setTextAndCheck(getString(R.string.SyncContacts), newSync, true);
                    } else if (position == contactsSuggestRow) {
                        textCheckCell.setTextAndCheck(getString(R.string.SuggestContacts), newSuggest, false);
                    } else if (position == newChatsRow) {
                        textCheckCell.setTextAndCheck(getString(R.string.ArchiveAndMute), archiveChats, false);
                    }
                    break;
                case 5:
                    ...
                    if (position == autoDeleteMesages) {
                        ...
                        textCell2.setTextAndValueAndIcon(getString(R.string.AutoDeleteMessages), value, true, R.drawable.msg2_autodelete, true);
                    } else if (position == sessionsRow) {
                        String count = "";
                        ...
                        textCell2.setTextAndValueAndIcon(getString(R.string.TwoStepVerification), value, true, R.drawable.msg2_permissions, true);
                    } else if (position == passcodeRow) {
                        int icon;
                        ...
                        textCell2.setTextAndValueAndIcon(getString(R.string.BlockedUsers), value, true, R.drawable.msg2_block2, true);
                    }
