...
public class RegexUserFilterPopup {
    public static void show(RegexFiltersSettingActivity fragment, View anchorView, float touchedX, float touchedY, long userId) {
        ...
        var windowLayout = createPopupLayout(layout, popupWindow, fragment, userId);
    ...
    private static ActionBarPopupWindow.ActionBarPopupWindowLayout createPopupLayout(ActionBarPopupWindow.ActionBarPopupWindowLayout layout, ActionBarPopupWindow popupWindow, RegexFiltersSettingActivity fragment, long userId) {
        ...
        editBtn.setOnClickListener(view -> {
            fragment.showEditCustomFilteredUserDialog(userId);
            popupWindow.dismiss();
        });
        ...
        deleteBtn.setOnClickListener(view -> {
            fragment.deleteCustomFilteredUser(userId);
            popupWindow.dismiss();
        });
